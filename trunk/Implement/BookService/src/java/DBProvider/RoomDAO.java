...
public class RoomDAO {
    public String bookRoom(int soPhong, KhachHangDTO khach, String ngayDat) throws FileNotFoundException, IOException, ParseException {
    ...
    public Integer[] getListRoomAvailable() throws IOException
    {
        Connector connector = new MySqlConnector();
    ...
    public boolean cancelBookRoom(String securityCode) throws IOException {
        //TODO write your implementation code here:
